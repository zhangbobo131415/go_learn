...
var _ = sayhello.GoUnusedProtection__

func Usage() {
  fmt.Fprintln(os.Stderr, "Usage of ", os.Args[0], " [-h host:port] [-u url] [-f[ramed]] function [arg1 [arg2...]]:")
  flag.PrintDefaults()
  fmt.Fprintln(os.Stderr, "\nFunctions:")
  fmt.Fprintln(os.Stderr, "  string sayhello(string msg)")
  fmt.Fprintln(os.Stderr, "  string sum(i32 a, i32 b)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  _ = math.Abs
  flag.Usage = Usage
  flag.StringVar(&host, "h", "172.21.13.121", "Specify host and port")
  ...
  client := sayhello.NewHelloAndSumClient(thrift.NewTStandardClient(iprot, oprot))
